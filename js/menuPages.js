...
<div class="menuPage">
    ...
    <p class="item-desc">
        insalata mista con pomodori freschi, pollo grigliato, crostini dorati e salsa Caesar fatta a casa
    </p>
    ...
    <p class="item-desc">
        salmone grigliato con insalata mista, pomodorini freschi, il tutto rifinito con salsa al limone e miele
    </p>
...
<div class="menuPage">
    ...
    <h2 class="section-title">SNACKES</h2>
    ...
    <p class="item-desc">
        triangoli di pasta ripieni di verdure speziate, fritti, serviti con chutney (salsa) alla menta
    </p>
    ...
    <p class="item-desc">
        riso basmati profumato alle spezie, pollo marinato e cotto lentamente, cipolle croccanti, coriandolo fresco, servito con salsa raita allo yogurt (piatto ricco, aromatico e saporito)
    </p>
    ...
    <p class="item-desc">
        pollo in morbida salsa cremosa al burro e pomodoro, leggermente speziato, accompagnato dal riso basmati e butter naan (piadine al burro)
    </p>


    <!-- ⭐ TIKKA IMAGE (RIGHT SIDE, BELOW) -->
    <div class="img-slot" 
        style="background-image:url('../assets/menu/biryani.png');
    ...
    <p class="item-desc">
        bocconcini di pollo marinati e cotti in salsa speziata al pomodoro e panna, servito con riso basmati
    </p>
    ...
    <p class="item-desc">
        lenticchie speziate saltate con burro chiarificato, coriandolo e spezie, servito con riso basmati
    </p>
    ...
    <p class="item-desc">
        morbido, leggero e perfetto per accompagnare curry
    </p>
    ...
    <p class="item-desc">
        chips giganti fatti con farina di lenticchie o ceci, leggermente speziati, croccanti e sottili
    </p>
